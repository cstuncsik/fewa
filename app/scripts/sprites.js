game.sprite = {
    ...
    show: function() {
        ...
        for (var i in this.items) {
            game.ctx.save();
            game.ctx.translate(cnt * game.brickWidth, 100);
            game.ctx.drawImage(this.items[i], 0, 0);
            game.ctx.restore();
            cnt += 1.1;
        }
    },
    factory: function() {
        ...
        this.create('AIR-BRICK-special', game.brickWidth, game.brickHeight, function(c) {
            //game.rect(c, linewidth * 2, linewidth * 2, game.brickWidth - linewidth * 2, game.brickHeight - linewidth * 2, radius, game.elements.AIR.color, linewidth, game.elements.AIR.color);
        ...
        this.create('EARTH-SHOT', game.brickWidth, game.brickHeight, function(c) {
            ...
            //c.fillRect(w2 - w10, 0, w10 * 2, game.brickHeight);
        ...
        this.create('WATER-SHOT', game.brickWidth, game.brickHeight, function(c) {
            //c.fillStyle = game.elements.WATER.color;
            //c.fillRect(w2 - w10, 0, w10 * 2, game.brickHeight);
        ...
        this.create('FIRE-SHOT', game.brickWidth, game.brickHeight, function(c) {
            //c.fillStyle = game.elements.FIRE.color;
            //c.fillRect(w2 - w10, 0, w10 * 2, game.brickHeight);
